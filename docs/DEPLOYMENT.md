...
| Variable | Default | Description |
|----------|---------|-------------|
| `OPENROUTER_SYNC_INTERVAL` | 3600 | Seconds between syncs (1 hour) |
| `LMSYS_SYNC_INTERVAL` | 86400 | Seconds between syncs (24 hours) |
| `HUGGINGFACE_SYNC_INTERVAL` | 86400 | Seconds between syncs (24 hours) |
...
3. **Create ECS cluster and task definition**
   - Use AWS Console to create cluster
...
2. **SSRF Protection**: Configure `ORCHESTRATOR_ALLOWED_DOMAINS`
3. **Rate Limiting**: Implement with reverse proxy
...
| Load | Deployment | Database | Caching |
|------|------------|----------|---------|
| < 10k req/day | Docker Compose | SQLite | Local |
| 10k-100k req/day | Single Docker | PostgreSQL | Redis |
| > 100k req/day | Kubernetes | PostgreSQL | Redis Cluster |
